...
export default function Terms() {
  return (
    <Container maxWidth="md" sx={{ py: 8 }} id="main-content" component="main">
      <Head>
        <title>Terms of Service - PhaseThru</title>
      </Head>
      <Paper sx={{ p: 4 }}>
        <Typography variant="h3" component="h1" gutterBottom>Terms of Service</Typography>
        <Typography variant="body1" paragraph>
          Last Updated: March 2026
        </Typography>
        
        <Typography variant="h5" component="h2" gutterBottom sx={{ mt: 4 }}>1. Acceptance of Terms</Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="h5" component="h2" gutterBottom sx={{ mt: 4 }}>2. User Contributions</Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="h5" component="h2" gutterBottom sx={{ mt: 4 }}>3. Disclaimer</Typography>
        <Typography variant="body1" paragraph>
