  ...
  return (
    <Container maxWidth="md" sx={{ py: 8 }} id="main-content" component="main">
      ...
      <Paper sx={{ p: 4 }}>
        ...
        <Typography variant="h5" component="h2" gutterBottom sx={{ mt: 4 }}>1. Information We Collect</Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="h5" component="h2" gutterBottom sx={{ mt: 4 }}>2. How We Use Information</Typography>
        <Box sx={{ mb: 2 }}>
        ...
        <Typography variant="h5" component="h2" gutterBottom sx={{ mt: 4 }}>3. Data Storage</Typography>
        <Typography variant="body1" paragraph>
